...
%   [logLik, hFiltered, logPredDensity, varForecast] = bootstrap(..., opts)
%
%   Inputs
%   ------
...
%                                   (default false)
%                 .returnIncrements true -> also return per-step predictive
%                                   log-density and one-step predicted
...
%     logPredDensity : T-by-1 per-step log p(y_t | y_{1:t-1}, theta), or []
%                      unless opts.returnIncrements.
%     varForecast    : T-by-1 one-step predicted variance
%                      E[exp(h_t) | y_{1:t-1}, theta], or [] unless
%                      opts.returnIncrements.
%
%   Numerical notes
%   ---------------
...
%   See PROPOSED_METHODOLOGY.md §9.3.
    ...
    defaults.returnIncrements = false;
